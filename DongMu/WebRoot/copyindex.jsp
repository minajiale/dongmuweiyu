   ...
   <body>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li onclick="setTab(1,6)" id="1" ><a href="#">提醒服务</a></li>
            <li class="active" id="2" onclick="setTab(2,6)"><a href="#">统计</a></li>
            <li><a href="#">Export</a></li>
          </ul>
          <ul class="nav nav-sidebar">
            <li id="3" onclick="setTab(3,6)" ><a href="">财务管理</a></li>
            <li id="4" onclick="setTab(4,6)"><a href="">产品管理</a></li>
            <li id="5" onclick="setTab(5,6)"><a href="">订单管理</a></li>
            <li id="6" onclick="setTab(6,6)"><a href="">店员管理</a></li>
          </ul>
        </div>
            ...
            <div id="demo1" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main apiright" style="display: none;" id="containmaid"> <%@include file="./IndexPart/alarm.jsp" %>  </div>
   	        <div id="demo2" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main apiright" style="display: block;" id="containmaid"> <%@include file="./IndexPart/nanlyse.jsp" %>  </div>
    ...
    <script type="text/javascript">
     function setTab(m,n){
		  ...
		  for(var i=1;i<=n;i++){
			   var clickLi= document.getElementById(i);
